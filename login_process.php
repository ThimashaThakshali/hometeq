		...
		//else
			...
			//else
				...
				if($arrayu['userType'] == 'C'){
					...
					echo"User type : hometeq customer</p><br/>";
					echo"<br/><p>Continue shopping for <a href = index.php>Home Tech</a><br/>";
					echo"View your <a href = basket.php>Smart Basket</a><br/></p>";
				}
				else{
					echo"<p>You are not a Customer!<br/>";
					echo"Go to <a href = staff_login.php >Staff Login</a></p>";
				}
