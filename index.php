<?php
	session_start();
	//include is used to import an external file
	//import another file to this one
	include ("db.php"); //include db.php file to connect to DB
	$pagename="Make your home smart"; //create and populate variable called $pagename
	//echo is used to display something on php page
	...
	while ($arrayp=mysqli_fetch_array($exeSQL)) 
	{
		echo "<tr>";
		    echo "<td style='border: 0px'>";
		        ...
		        echo "<img src=images/".$arrayp['prodPicNameSmall']." height=160 width=200>";
		        //close the anchor
				echo "</a>";
		    ...
		    echo "<td style='border: 0px'>";
				...
				echo "<p>".$arrayp['prodDescripShort']."</h6></p>"; //display product name as contained in the array
		        echo "<p><br/><b>£".$arrayp['prodPrice']."</b></p>"; //display product name as contained in the array
